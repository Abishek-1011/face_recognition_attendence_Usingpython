...
tata_image=face_recognition.load_image_file("G:\\pro_atten\\job\\tata.jpg")
tata_encoding=face_recognition.face_encodings(tata_image)[0]

mona_image=face_recognition.load_image_file("G:\\pro_atten\\job\\monalisa.jpg")
mona_encoding=face_recognition.face_encodings(mona_image)[0]

tesla_image=face_recognition.load_image_file("G:\\pro_atten\\job\\tesla.jpg")
